...
<div class="grid grid-4" style="margin-bottom:22px">
  <div class="stat"><div class="n"><?= num($stats['visitors']) ?></div><div class="l">Unique visitors</div></div>
  <div class="stat"><div class="n"><?= num($stats['pageviews']) ?></div><div class="l">Page views</div></div>
